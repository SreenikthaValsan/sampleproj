...
const Leads = () => {
  ...
  const API_BASE_URL = 'https://sampleproj-rho.vercel.app/getLeads';
            ...
            <tbody>
              {listings.map((listing, index) => (
                <tr key={index}>
                  ...
                  <td>{listing.status?.name || 'N/A'}</td>
                  <td>{listing.lead_stage || 'N/A'}</td>
                  <td>{listing.updated_at || 'N/A'}</td>
                  <td>{listing.enquiry_date || 'N/A'}</td>
                  <td>{listing.lead_details?.type || 'N/A'}</td>
                  <td>{listing.contact?.name || 'N/A'}</td>
